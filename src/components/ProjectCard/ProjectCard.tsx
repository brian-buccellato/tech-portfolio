  ...
  const projects: ProjectDetails[] = [
    {
      ...
      skills: [
        {name: 'Python', icon: '/src/assets/logo.svg'},
        {name: 'DBT', icon: '/src/assets/logo.svg'},
        {name: 'Terraform', icon: '/src/assets/logo.svg'},
        {name: 'AWS', icon: '/src/assets/logo.svg'},
        {name: 'ECS', icon: '/src/assets/logo.svg'},
        {name: 'ECR', icon: '/src/assets/logo.svg'},
        {name: 'AWS Secrets Manager', icon: '/src/assets/logo.svg'},
        {name: 'Docker', icon: '/src/assets/logo.svg'},
        {name: 'Redshift', icon: '/src/assets/logo.svg'},
        {name: 'Github Actions', icon: '/src/assets/logo.svg'},
      ],
    ...
    },
    {
      ...
      skills: [
        {name: 'React', icon: '/src/assets/logo.svg'},
        {name: 'Material UI.', icon: '/src/assets/logo.svg'},
        {name: 'AWS Cloudfront', icon: '/src/assets/logo.svg'},
        {name: 'AWS S3', icon: '/src/assets/logo.svg'},
        {name: 'Github Actions', icon: '/src/assets/logo.svg'},
      ],
